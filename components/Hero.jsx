...
export default function Hero(){
    return(
        <main id="hero" className="h-screen w-full  grid content-between justify-items-center lg:content-center text-white font-bold pt-10 px-5 lg:px-20 xl:px-48 z-0">
            ...
            <section className="flex items-center h-max w-full justify-center gap-3 -translate-y-10">
