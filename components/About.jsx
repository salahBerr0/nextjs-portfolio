    ...
    <main ref={aboutSectionRef} id="about" className="h-max grid content-start justify-items-center">
      <section className="flex items-center justify-center w-full">
        ...
        <article className="grid content-center justify-items-center gap-1">
          <span className='text-[#ffffff] w-full flex items-center justify-center rounded-lg text-[15px] md:text-[18px]'>
      ...
      <section className="w-full grid content-center justify-items-center px-16 gap-10 mb-5">           
        <span className='text-[35px] w-full font-bold text-center' style={{textShadow:'0 0 10px #fff'}}>
          Web Frontend Developer & Graphic Designer
        </span>
        <article className="grid content-center justify-items-center w-full gap-2">
          <p className="text-[#dfd9ff] w-full font-medium lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px] text-center">
      ...
      <section className='border-2 h-max border-white rounded-md p-3 relative grid content-center justify-items-center mx-16 gap-2 backdrop-blur-md' style={{boxShadow:'0 0 5px #ffffff'}}>
        <p className="text-gray-200 text-[18px] text-center">
          I deliver end-to-end branding solutions, from visual identity and logo design to front-end website development. Discover my capabilities through the projects featured in my portfolio.
        </p>
        <ScrollLink 
          to="project" 
          smooth={true} 
